  ...
  return (
    <div className="grid gap-6 xl:grid-cols-[.8fr_1.2fr]">
      <div className="card p-6">
        ...
        <p className="mt-2 text-sm leading-6 text-muted">The demo produces artifacts that can be inspected outside the app: a guarded memo, full JSON payload and short portfolio summary.</p>
        <div className="mt-5 grid gap-3">
          ...
          <button onClick={onCopySummary} className="rounded-xl border border-line bg-white px-4 py-3 text-sm font-semibold text-muted transition hover:border-[#BFD8D3] hover:text-accent">Copy portfolio summary</button>
        </div>
      </div>
