...
const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    ready: 'Ready',
    analysisPromptTitle: 'Ready to analyze',
    ...
    summary: 'Summary',
    copied: 'Copied',
    reportDownloaded: 'Markdown report downloaded',
    jsonDownloaded: 'Full JSON downloaded',
    summaryCopied: 'Analysis summary copied',
    ...
    sourceCached: 'Real market data · Yahoo Finance',
    sourceLive: 'Real market data · Yahoo Finance',
  ...
  es: {
    ...
    ready: 'Listo',
    analysisPromptTitle: 'Listo para analizar',
    ...
    summary: 'Resumen',
    copied: 'Copiado',
    reportDownloaded: 'Informe Markdown descargado',
    jsonDownloaded: 'JSON completo descargado',
    summaryCopied: 'Resumen del análisis copiado',
    warnings: 'Warnings / guardrails',
    dashboard: 'Panel',
    traceback: 'Regime Traceback',
    ...
    sourceCached: 'Datos reales · Yahoo Finance',
    sourceLive: 'Datos reales · Yahoo Finance',
